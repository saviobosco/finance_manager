        ...
        <div class="panel panel-inverse" data-sortable-id="index-6">
            ...
            <div class="panel-body p-t-0">
                <table class="table table-valign-middle m-b-0">
                    ...
                    <tbody>
                    <tr>
                        <td><label class="label label-danger"> School Fees</label></td>
                        <td>13,203 <span class="text-success"><i class="fa fa-arrow-up"></i></span></td>
                        <td><div id="sparkline-unique-visitor"></div></td>
                    </tr>
                    <tr>
                        <td><label class="label label-warning">P.T.A</label></td>
                        <td>28.2%</td>
                        <td><div id="sparkline-bounce-rate"></div></td>
                    </tr>
                    <tr>
                        <td><label class="label label-success">Sport Fees</label></td>
                        <td>1,230,030</td>
