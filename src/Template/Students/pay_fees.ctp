            ...
            <div class="panel-body">
                ...
                <!--<div class="row">
                    <div class="col-sm-6">
                        ...
                        ?>
                        <h5> Bank Deposit</h5>
                        <?= $this->Form->control('bank_deposit.teller_number') ?>
                        <?= $this->Form->control('bank_deposit.bank_id',['options'=>$banks]) ?>
                        <?= $this->Form->control('bank_deposit.amount_paid') ?>
                        <?= $this->Form->control('bank_deposit.depositor_name') ?>
                        <?= $this->Form->control('bank_deposit.date_paid',['type'=>'date']) ?>

                    </div>
                    <div class="col-sm-6">
                        <h5> Bank transfer</h5>
                        <?= $this->Form->control('bank_transfer.account_number_paid_from') ?>
                        <?= $this->Form->control('bank_transfer.bank_paid_from_id',['options'=>$banks]) ?>
                        <?= $this->Form->control('bank_transfer.account_number_paid_to') ?>
                        <?= $this->Form->control('bank_transfer.bank_paid_to_id',['options'=>$banks]) ?>
                        <?= $this->Form->control('bank_transfer.amount_paid') ?>
                        <?= $this->Form->control('bank_transfer.date',['type'=>'date']) ?>
