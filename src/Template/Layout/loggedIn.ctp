...
<div id="page-container" class="page-sidebar-fixed page-header-fixed">
    ...
    <!-- end #content -->
    <div class="footer">
        <p class="pull-right"><?= Configure::read('Application.Name') ?> version <?= Configure::read('Application.Version') ?> Powered by <a class="text-orange" href="http://www.upsitech.com" title="Visit upsitech" data-toggle='tooltip' trigger="focus" ><?= Configure::read('Application.Company') ?></a> All copyright reserved. &copy;</p>
    </div>
