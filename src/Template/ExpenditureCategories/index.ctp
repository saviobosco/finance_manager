...
<div class="expenditureCategories index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $expenditureCategory->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $expenditureCategory->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $expenditureCategory->id], ['confirm' => __('Are you sure you want to delete # {0}?', $expenditureCategory->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
