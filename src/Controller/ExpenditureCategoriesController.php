 ...
 *
 * @property \App\Model\Table\ExpenditureCategoriesTable $ExpenditureCategories
 *
 * @method \App\Model\Entity\ExpenditureCategory[] paginate($object = null, array $settings = [])
 */
