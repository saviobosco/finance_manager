...
class StudentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gender' => ['type' => 'string', 'length' => null, 'null' => true, 'default' => '', 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'first_name' => 'Lorem ipsum dol',
            'last_name' => 'Lorem ipsum',
            'date_of_birth' => '2017-10-24',
            'gender' => 'male',
            'state_of_origin' => 'Lorem ipsum',
            'religion' => 'Lorem ',
            'home_residence' => 'Lorem ipsu',
            'guardian' => 'Lorem ipsum',
            'relationship_to_guardian' => 'Lorem',
            'occupation_of_guardian' => 'Lorem',
            'guardian_phone_number' => 'Lorem ',
            'session_id' => 1,
            'class_id' => 1,
            'class_demarcation_id' => 1,
            'photo' => 'Lorem',
            'photo_dir' => 'Lorem ',
            'created' => '2017-10-24 19:16:36',
            'modified' => '2017-10-24 19:16:36',
            'status' => 1,
            'state_id' => 1
        ],
    ];
